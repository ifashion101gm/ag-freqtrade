...
class ExecutionEngine:
    def __init__(self, strategy):
        self.s = strategy
        # instantiate phase modules from strategy.config
        cfg = strategy.config
        ...
        self.position = None  # active trade state
    ...
    def on_bar_1m(self, bar_1m, bar_5m, bar_15m, bar_1h, bar_4h):
        ...
        return Signal(direction,6,trig.entry_price,risk_plan.sl_price,tp1,tp2,risk_plan.lots,rr,reason,{
